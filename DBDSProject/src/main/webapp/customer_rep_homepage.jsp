...
<body>
    ...
    <main>
        <div class="welcome-container">
            ...
            %>
            <div class="welcome-btn">Welcome, Customer Rep <%= fullName %>!</div>
        </div>
        <div class="button-container">
            ...
            <a href="customer_reservations.jsp?username=<%= session.getAttribute("username") %>" class="btn">Customer Reservations</a>
            <a href="cust_rep_faq.jsp?username=<%= session.getAttribute("username") %>" class="btn" id="faq-button">Customer FAQ</a>
        </div>
    </main>
</body>
</html>
